...
```text
├─ docs                          : doc files for hmarko89.github.io/mathoptintro/
└─ src                           : source codes
   ├─ sendmoremoney.py           :   cryptarithmetic puzzle (SEND + MORE = MONEY) [cp]
   ├─ sudoku.py                  :   sudoku puzzle [cp|mip]
   ├─ queens.py                  :   n-queens puzzle [cp|mip]
